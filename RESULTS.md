...
| `20260806-*` (T2) | **classifier-only adaptation**: B1's trunk frozen, 2 epochs on pseudo-labels | — | — | — | **probe 0.7572 / held-out 0.7621 — 83 % and 89 % of full self-training's gain, on a frozen backbone in 2 epochs.** Adapting to a new trap is minutes, not hours | ucloud |
