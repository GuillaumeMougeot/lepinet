...
| `20260730-*` (A2) | **DINOv3-cnx-L, single head + ArcFace × z-score** | **0.9216** (0.9436) | 0.9610 | 0.9754 | **best open-set-capable model.** Replicates A1's ArcFace cost to within 0.06 pt at 10× scale (−0.95/−1.21/−1.13), so the cost is not capacity-bound. Shifted + AUROC running | ucloud |
