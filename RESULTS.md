...
| `20260807-*` (G2) | **staged recipe at 198 M** — L5 + cRT + adaptation, both frozen-trunk | **0.9150** (—) | — | — | **probe 0.7648 / held-out 0.7600. Best in-distribution model in the project.** vs B8 end-to-end: **+0.90 in-dist, −1.50 probe** — the same trade as at 20 M (+0.78 / −1.65) | ucloud |
| `20260807-*` (F3) | **joint** classifier stage (rebalanced + adapted at once) | 0.9061 (—) | — | — | probe 0.7479 / **held-out 0.7703**. Near-wash with F2's two sequential stages: −0.62 probe, **+1.09 held-out**, at half the cost | ucloud |
| `20260807-*` (R2) | **second self-training round**, re-labelled with F2 | — | — | — | **probe 0.7161 — 3.80 pt WORSE than round 1.** Labels were *more* accurate (99.84 % vs 98.15 %) but covered **156 species vs 346**: a better labeller separates its confidences, so a fixed 30 % quantile keeps a narrower set | ucloud |
