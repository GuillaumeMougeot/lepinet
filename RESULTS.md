...
Generated 2026-08-27 09:38 from `data/global/{models,preds}`, which is gitignored machine-local storage — this file is the only copy of this table that leaves the training box.
