...
| **P5 (running)** | the same adaptation **unfrozen**, to separate substitution from the frozen-readout handicap P1b measured. Predicted probe 0.74-0.79, falsified below 0.7300. |
| **L7c1000b, P4b (running)** | **repeats.** Both claims rest on n = 1 and G3b showed a 3.74 pt spread between identical runs. The uncapped L7 control already has n = 2. |
