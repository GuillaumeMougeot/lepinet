...
| **P4 (running)** | the full recipe on the better backbone: P3c + our 2-epoch adaptation stage. Predicted probe **0.76-0.80**, falsified below 0.7400. Compose -> new best model; near T2b -> adaptation and pretraining are substitutes. |
