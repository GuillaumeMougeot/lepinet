...
| [2026-07-lepi-app-claude.md](2026-07-lepi-app-claude.md) | ↳ the detailed plan: size budget, phases A–E, open decisions | PLAN — nothing built; predictions in §8 are unmeasured |
