...
| [2026-07-src-lepinet-baseline-port.md](2026-07-src-lepinet-baseline-port.md) | How to port the 0.9148 baseline into a clean, fastai-only, mini_trainer-free `src/lepinet`? | IN PROGRESS — package built, refactored for clarity, packaged (typer/CI/Pages/reproducible venv); train-parity run + eval running on UCloud B200 |
| [2026-07-bigger-everything.md](2026-07-bigger-everything.md) | Does a bigger, cutting-edge model (ConvNeXtV2-L, higher res, MixUp) beat 0.9148 and make a good distillation teacher? | OPEN — queued on UCloud B200 (smoke + 6ep full run); predictions logged before results |
