...
| [08-08](2026-08-08-self-training-does-not-iterate.md) | Does a second self-training round help? | **RESOLVED — no, it costs 3.80 pt**, and not through circularity: a better labeller separates its confidences, so a fixed 30 % quantile keeps **156 species instead of 346**. Coverage beats label accuracy |
