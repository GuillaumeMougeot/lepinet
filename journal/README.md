...
| [2026-07-bigger-everything.md](2026-07-bigger-everything.md) | Does a bigger, cutting-edge model (ConvNeXtV2-L / DINOv3, ArcFace) beat 0.9148 and make a good distillation teacher? | OPEN — ConvNeXtV2-L teacher training; ArcFace + DINOv3/ViT plumbing built & smoke-validated on B200 (arcface & dinov3-vitb smokes passed) |
| [2026-07-teacher-student-app-bridge.md](2026-07-teacher-student-app-bridge.md) | How to make shipping a model (teacher→small student→app bundle→release) one command? | OPEN — interop half done (package export emits app-ready bundle, verified on 5ep, parity 2e-5); quantize/distill/release + ORT-Web QDQ fix next |
