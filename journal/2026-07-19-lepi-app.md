...
**Kind:** subproject · **Status:** RESOLVED as a proposal (2026-07-19) — the size analysis here
(heads are 51 % of the model; <1 MB is not honest, ≤8 MB is) set the budget the rest of the app work
was built against. Execution moved to [[2026-07-20-lepi-app-claude]] and
[[2026-07-20-lepi-app-compression]]; the app shipped.
...
proposal is in [`2026-07-20-lepi-app-claude.md`](2026-07-20-lepi-app-claude.md).*
...
[`2026-07-20-lepi-app-claude.md`](2026-07-20-lepi-app-claude.md).