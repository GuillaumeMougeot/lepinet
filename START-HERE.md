...
| 7 | **Unlabelled target data supplies *coverage of the input space*; its *class distribution* is a second knob that only pays on a frozen trunk, and only at small scale.** Coverage: 0.39 % of training buys 97 % of the gain, and trading 24.6 pt of label accuracy for 740 more species buys **+4.24 pt**. Balance: **+1.51/+1.87** to a frozen classifier at 20 M, **−0.71/−3.62** to end-to-end, and **+0.92/−0.82** to a frozen classifier at 198 M. It is resampling applied to the pseudo-labels, and it inherits resampling's scale profile. | [iteration](journal/2026-08-08-self-training-does-not-iterate.md), [scale](journal/2026-08-10-balance-is-oversampling-and-it-does-not-scale.md) |
