...
| 2 | **One species head + marginalisation beats the multi-head at *every* level** (0.9135/0.9606/0.9739 vs 0.9110/0.9587/0.9708) — fewer parameters, and coarse levels cannot contradict the species call. **But it loses 2.1 pt under domain shift** unless the marginals are also *supervised during training*, which recovers 1.41 of it for free: **coarse supervision buys robustness, coarse parameters do not.** | [story](journal/DIRECTIONS.md), [marginal](journal/2026-07-30-marginal-supervision.md) |
