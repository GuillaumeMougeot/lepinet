...
| 7 | **Unlabelled target data supplies *coverage of the input space*, and its *class distribution* is a second, independent knob.** Coverage: 0.39 % of training buys 97 % of the gain, and trading 24.6 pt of label accuracy for 740 more species buys **+4.24 pt**. Balance: adding the head of the long-tailed target distribution is **+0.89 probe / −2.24 held-out species**. Take both — full coverage, balanced replication — and they compose with no confidence gate at all: **probe 0.7692, held-out 0.7781**, the best on both shifted axes. | [iteration](journal/2026-08-08-self-training-does-not-iterate.md) |
